...
class script(object):
    START_TXT = """
<b>ɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏꜰɪʟᴛᴇʀ ʙᴏᴛ.</b>
<b>ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ – ɪ ᴡɪʟʟ ɢɪᴠᴇ ᴍᴏᴠɪᴇs ᴏʀ sᴇʀɪᴇs ᴅɪʀᴇᴄᴛʟʏ ɪɴ ɢʀᴏᴜᴘ ᴀɴᴅ ᴘᴍ!</b> 😍 <a href="https://t.me/JISSHU_BOTS">Jisshu Bots &lt;/&gt;</a> """
