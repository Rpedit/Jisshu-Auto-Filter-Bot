...
# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rpeditz:Rpeditz@rpeditz.v6ivkrh.mongodb.net/?retryWrites=true&w=majority&appName=Rpeditz")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rpeditz")

# Files index database url
FILES_DATABASE = environ.get('FILES_DATABASE', "mongodb+srv://shivaksh2429:hdhub@shivaksh25.iquaryq.mongodb.net/?retryWrites=true&w=majority&appName=shivaksh25")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'rpeditz')

# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002861423340'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002540946493') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002753874360')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/smsupport')
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+6FXKgzfFZ081NGY1')
...
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/6c349b0ec71fde03fc58f-84852f07ce3be691ff.jpg')).split()
